...
function BlueskyIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266.902 1.565.139 1.908 0 3.08 0 3.768c0 .69.378 5.65.624 6.479.815 2.736 3.713 3.66 6.383 3.364.136-.02.272-.04.407-.063-.136.02-.272.047-.407.073-2.62.49-6.94 1.77-6.94 6.45 0 4.905 5.355 7.59 7.537 4.2 1.594-2.478 2.235-5.756 2.396-7.322.16 1.566.802 4.844 2.396 7.322 2.182 3.39 7.538.705 7.538-4.2 0-4.68-4.32-5.96-6.94-6.45a11.376 11.376 0 01-.408-.073c.136.024.272.044.408.063 2.67.296 5.568-.628 6.383-3.364.246-.828.624-5.79.624-6.478 0-.69-.139-1.861-.902-2.206-.659-.298-1.664-.62-4.3 1.24C16.046 4.748 13.087 8.687 12 10.8z" />
    </svg>
  )
}
